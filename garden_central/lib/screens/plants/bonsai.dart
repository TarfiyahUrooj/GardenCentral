...
class Bonsai extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore.collection('Bonsai').snapshots(),
            ...
            return Column(
              children: [
                Container(
                  ...
                  //color: Colors.amber,
                  // Add properties to customize the container
                ),
                Expanded(
